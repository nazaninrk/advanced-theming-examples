...
df2 = pd.DataFrame({
    ...
    "Last Visit": pd.date_range(start="2023-01-01", periods=1000),
...
with st.sidebar:
    ...
    quarters = st.pills("Quarter", options=df1["Quarter"].unique(), selection_mode="multi")
    regions = st.pills("Region", options=df1["Region"].unique(), selection_mode="multi")
    status = st.pills("Status", options=df1["Status"].unique(), selection_mode="multi")
    ...
    loyalty_levels = st.pills("Loyalty Level", options=df2["Loyalty Level"].unique(), selection_mode="multi")
    ...
    categories = st.pills("Category", options=df3["Category"].unique(), selection_mode="multi")
    stock_status = st.pills("Stock Status", options=df3["Stock Status"].unique(), selection_mode="multi")
