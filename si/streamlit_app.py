...
title = "Snowflake Intelligence theme"
icon = "❄️"
...
radio_input = st.radio(
    "st.radio horizontal", ["cat", "dog"], horizontal=True, help=help, disabled=disabled
)
st.write(f"Your radio input is {radio_input}!")
...
slider_input = st.slider(
    "st.slider", value=[30, 60] if range_sliders else 30, disabled=disabled, help=help
)
