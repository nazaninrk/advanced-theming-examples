...
st.set_page_config("NTT Docomo theme", "📞")
st.logo("https://upload.wikimedia.org/wikipedia/commons/1/1b/NTT_DoCoMo_logo.svg")
st.title("NTT Docomo theme")

if st.checkbox("Enable CSS hacks", True):
    
    titleFontSize = "22.12px"
    titleFontWeight = "700"
    headerFontSize = "18.06px"
    headerFontWeight = "700"
    subheaderFontSize = "16.1px"
